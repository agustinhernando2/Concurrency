...
public class PrintQueue {
	 ...
	 */
	public PrintQueue(){
		semaphore=new Semaphore(3,true); 	//iniciado en 3 ya que tenemos 3 impresoras
		freePrinters=new boolean[3]; 					//estados de las impresoras
		for (int i=0; i<3; i++){
			freePrinters[i]=true;
		}
...
//y como indico Fairness?...puedo garantizar orden de llegada impresion?
